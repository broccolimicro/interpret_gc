NAME          = interpret_gc
DEPEND        = gc arithmetic interpret_arithmetic parse_gc parse_expression parse common
TEST_DEPEND   = gc arithmetic interpret_arithmetic parse_gc parse_expression parse common
